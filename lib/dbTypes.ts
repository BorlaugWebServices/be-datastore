...
/** audit_activity */
export type AuditActivityRow = ActivityRow<'audit_id', number>;
...
/** sequence_activity */
export type SequenceActivityRow = ActivityRow<'sequence_id', number>;
...
/** proposal_activity */
export type ProposalActivityRow = ActivityRow<'proposal_id', number>;
...
/** group_activity */
export type GroupActivityRow = ActivityRow<'group_id', number>;
...
/** catalog_activity */
export type CatalogActivityRow = ActivityRow<'catalog_id', number>;
